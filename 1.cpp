...
class libary{
	...
	public:	
		...
		void borrowSearchSelect();
		void searchBorrowers1();
...
//Main Menu	
	...
	cout<<"\t\t\t|                          03: All Books &  Borrowers              |"<<endl;
...
//get input
	...
	switch(uInput){
		...
		case 3:{
			...
			cout<<"01) View All Books List-------------"<<endl;
			cout<<"02) View All Borrowers List Books---"<<endl;
			cout<<"03) Back----------------------------"<<endl;
...
int	bseInput;	
	...
	//do{
		...
		cout<<"\t\t\t|                   07.View all Borrowers                           |"<<endl;
...
int ch;
	...
	cout<<"\t\t\t\t---------------------------------------"<<endl;
		...
		cout<<"Enter Book Name Which One Want to Search: ";
		cin>>bookName;
...
void libary::borrowSearchSelect(){
...
int ch;
	...
	cout<<"\t\t\t\t---------------------------------------"<<endl;
		...
		cout<<"Enter Boroower Name Which One Want to Search: ";
		cin>>bname;
